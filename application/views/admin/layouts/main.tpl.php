...
<html>
	<head>
		<title><?php echo $this->config->item('site_title'); if(isset($title))echo " ".$this->config->item('site_title_delimiter')." ".$title;?></title>	
			...
			<link type='text/css' href="<?php echo base_url();?>twitter-bootstrap/css/bootstrap-responsive.min.css" rel='Stylesheet' />    
	...
	<body>
			...
			<div class="container">				
				...
				<div class="navbar navbar-fixed-top navbar-inverse">
					<div class="navbar-inner navbar-inverse">
						<div class="container">
							<?php $this->load->view('admin/partials/menu.tpl.php',$data);?>
						</div>
					</div>
				</div>
		...
		<div id="footer">
			<div class="container">
				<div id="copywright"><?php $this->load->view('admin/partials/copywright.tpl.php');?></div>
			</div>
		</div>
	</body>
</html>